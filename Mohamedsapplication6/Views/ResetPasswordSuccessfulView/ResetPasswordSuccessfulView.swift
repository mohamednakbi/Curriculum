...
struct ResetPasswordSuccessfulView: View {
    @StateObject var resetPasswordSuccessfulViewModel =
        ResetPasswordSuccessfulViewModel(_isOpen: .constant(false))
        ...
        VStack {
            VStack {
                ...
                Text(StringConstants.kMsgCongratulations)
                    ...
                    .frame(width: getRelativeWidth(178.0), height: getRelativeHeight(29.0),
                           alignment: .topLeading)
                    .padding(.top, getRelativeHeight(34.0))
                Text(StringConstants.kMsgYourAccountIs)
                    .font(FontScheme.kUrbanistRegular(size: getRelativeHeight(18.0)))
                    .fontWeight(.regular)
                    .foregroundColor(ColorConstants.WhiteA700)
                    .minimumScaleFactor(0.5)
                    .multilineTextAlignment(.leading)
                    .frame(width: getRelativeWidth(226.0), height: getRelativeHeight(22.0),
                           alignment: .topLeading)
                    .padding(.top, getRelativeHeight(17.0))
                Button(action: {}, label: {
                    HStack(spacing: 0) {
                        Text(StringConstants.kLblGoToHomepage)
            ...
            .frame(width: getRelativeWidth(340.0), height: getRelativeHeight(444.0),
                   alignment: .center)
...
struct ResetPasswordSuccessfulView_Previews: PreviewProvider {
