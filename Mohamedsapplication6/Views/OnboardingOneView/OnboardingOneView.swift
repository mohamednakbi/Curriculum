            ...
            VStack {
                VStack {
                    ...
                    Text("group2592")
                        ...
                        .frame(width: getRelativeWidth(60.0), height: getRelativeHeight(113.0))
                    ...
                    HStack {
                        Button(action: {
                            onboardingOneViewModel.nextScreen = "LetsYouInView"
                        }, label: {
                            HStack(spacing: 0) {
