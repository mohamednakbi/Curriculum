            ...
            VStack {
                VStack {
                    ...
                    VStack {
                        Image("img_image")
                            .resizable()
                            .frame(width: getRelativeWidth(240.0), height: getRelativeWidth(240.0),
                                   alignment: .center)
                            .scaledToFit()
                            .clipped()
                            .padding(.top, getRelativeHeight(19.0))
                        Text(StringConstants.kMsgSelectWhichCo)
                            .font(FontScheme.kUrbanistRegular(size: getRelativeHeight(16.0)))
                            .fontWeight(.regular)
                            .foregroundColor(ColorConstants.WhiteA700)
                            .minimumScaleFactor(0.5)
                            .multilineTextAlignment(.leading)
                            .frame(width: getRelativeWidth(371.0), height: getRelativeHeight(46.0),
                    ...
                    .frame(width: UIScreen.main.bounds.width, height: getRelativeHeight(726.0),
                           alignment: .center)
                    Button(action: {
                        forgotPasswordViewModel.nextScreen = "ForgotPasswordTypeOTPView"
                    }, label: {
                        HStack(spacing: 0) {
                ...
                Group {
                    NavigationLink(destination: ForgotPasswordTypeOTPView(),
                                   tag: "ForgotPasswordTypeOTPView",
