...
public extension RangeSlider {
    init<V>(range: Binding<ClosedRange<V>>, in bounds: ClosedRange<V> = 0.0 ... 1.0,
            step: V.Stride = 0.001,
            onEditingChanged: @escaping (Bool) -> Void = { _ in }) where V: BinaryFloatingPoint,
        V.Stride: BinaryFloatingPoint
    {
        self.init(RangeSliderStyleConfiguration(range: Binding(get: {
                                                                   CGFloat(range.wrappedValue
                                                                       .clamped(to: bounds)
                                                                       .lowerBound) ...
                                                                       CGFloat(range.wrappedValue
                                                                           .clamped(to: bounds)
                                                ...
                                                bounds: CGFloat(bounds.lowerBound) ...
                                                    CGFloat(bounds.upperBound),
                                                step: CGFloat(step),
...
public extension RangeSlider {
    init<V>(range: Binding<ClosedRange<V>>, in bounds: ClosedRange<V> = 0 ... 1, step: V.Stride = 1,
    ...
    var body: some View {
        VStack {
            ...
            RangeSlider(range: $range2)
                .rangeSliderStyle(HorizontalRangeSliderStyle(track:
                    HorizontalRangeTrack(view: Capsule().foregroundColor(.purple))
                    ...
                    lowerThumbSize: CGSize(width: 32,
                                           height: 32),
                    upperThumbSize: CGSize(width: 32,
                                           height: 32),
                    options: .forceAdjacentValue))

            RangeSlider(range: $range3)
                .rangeSliderStyle(HorizontalRangeSliderStyle(track:
                    HorizontalRangeTrack(view: LinearGradient(gradient: Gradient(colors: [.red,
                                                                                          .orange,
                                                                                          .yellow,
                                                                                          .green,
                                                                                          .blue,
                        ...
                        .background(LinearGradient(gradient: Gradient(colors: [.red, .orange,
                                                                               ...
                                                                               .pink]),
                            startPoint: .leading,
                            endPoint: .trailing).opacity(0.25))
                        .frame(height: 32)
                        .cornerRadius(16),
                    lowerThumb: HalfCapsule().foregroundColor(.white).shadow(radius: 3),
                    upperThumb: HalfCapsule().rotation(Angle(degrees: 180))
            ...
            RangeSlider(range: $range4)
                .frame(height: 64)
                .rangeSliderStyle(HorizontalRangeSliderStyle(track:
                    HorizontalRangeTrack(view: LinearGradient(gradient: Gradient(colors: [.purple,
                                                                                          .blue,
                                                                                          .purple]),
                                         startPoint: .leading,
                                         endPoint: .trailing),
                        ...
                        .padding(.vertical, 8),
                    lowerThumbSize: CGSize(width: 16,
                                           height: 64),
                    upperThumbSize: CGSize(width: 16,
                                           height: 64)))

            RangeSlider(range: $range5)
                .frame(height: 64)
                .rangeSliderStyle(HorizontalRangeSliderStyle(track:
                    HorizontalRangeTrack(view: LinearGradient(gradient: Gradient(colors: [.yellow,
                                                                                          .orange,
                                                                                          .red]),
                                         startPoint: .leading,
                                         endPoint: .trailing),
            ...
            RangeSlider(range: $range6, in: 1.0 ... 3.0)
                ...
                .frame(height: 128)
                .rangeSliderStyle(HorizontalRangeSliderStyle(track:
                    HorizontalRangeTrack(view: LinearGradient(gradient: Gradient(colors: [
                                             .blue,
                                             .red
                                         ]),
                                         startPoint: .leading,
                        ...
                        .background(Color.secondary.opacity(0.25)),
                    lowerThumbSize: CGSize(width: 8,
                                           height: 64),
                    upperThumbSize: CGSize(width: 8,
                                           height: 64)))
        }
        .padding()
    }
...
private struct VerticalRangeSlidersPreview: View {
    ...
    var body: some View {
        HStack {
            ...
            RangeSlider(range: $range2)
                .rangeSliderStyle(VerticalRangeSliderStyle(track:
                    VerticalRangeTrack(view: Capsule().foregroundColor(.purple),
                                       mask: Rectangle())
                        .background(Capsule().foregroundColor(Color.purple.opacity(0.25)))
                        .frame(width: 8),
                    lowerThumb: Circle().foregroundColor(.purple),
                    ...
                    lowerThumbSize: CGSize(width: 32,
                                           height: 32),
                    upperThumbSize: CGSize(width: 48,
                                           height: 48)))

            RangeSlider(range: $range3)
                .rangeSliderStyle(VerticalRangeSliderStyle(track:
                    VerticalRangeTrack(view: LinearGradient(gradient: Gradient(colors: [.red,
                                                                                        .orange,
                                                                                        .yellow,
                                                                                        .green,
                                                                                        .blue,
            ...
            RangeSlider(range: $range4)
                .frame(width: 64)
                .rangeSliderStyle(VerticalRangeSliderStyle(track:
                    VerticalRangeTrack(view: LinearGradient(gradient: Gradient(colors: [.purple,
                                                                                        .blue,
                                                                                        .purple]),
                                       startPoint: .bottom,
                                       endPoint: .top),
                    ...
                    lowerThumbSize: CGSize(width: 64,
                                           height: 16),
                    upperThumbSize: CGSize(width: 64,
                                           height: 16)))

            RangeSlider(range: $range5)
                .frame(width: 64)
                .rangeSliderStyle(VerticalRangeSliderStyle(track:
                    VerticalRangeTrack(view: LinearGradient(gradient: Gradient(colors: [.yellow,
                                                                                        .orange,
                                                                                        .red]),
                                       startPoint: .bottom,
                                       endPoint: .top),
...
public struct HalfCapsule: View, InsettableShape {
    ...
    public func path(in rect: CGRect) -> Path {
        ...
        return Path { path in
            ...
            path.addArc(center: CGPoint(x: minRadius, y: minRadius), radius: minRadius,
                        startAngle: Angle(degrees: 270), endAngle: Angle(degrees: 180),
                        clockwise: true)
            path.addArc(center: CGPoint(x: minRadius, y: height - minRadius), radius: minRadius,
                        startAngle: Angle(degrees: 180), endAngle: Angle(degrees: 90),
                        clockwise: true)
    ...
    public var body: some View {
        GeometryReader { geometry in
            self
                .path(in: CGRect(x: 0, y: 0, width: geometry.size.width,
