...
public struct HorizontalRangeSliderStyle<Track: View, LowerThumb: View,
    ...
    public func makeBody(configuration: Self.Configuration) -> some View {
        GeometryReader { geometry in
            ZStack {
                    ...
                    .environment(\.rangeTrackConfiguration,
                                 RangeTrackConfiguration(bounds: configuration.bounds,
                                                         ...
                                                         lowerTrailingOffset: self.lowerThumbSize
                                                             .width / 2 + self.upperThumbSize
                                                             .width,
                                                         upperLeadingOffset: self.lowerThumbSize
                                                             .width + self.upperThumbSize
                                                             .width / 2,
                ...
                .position(x: distanceFrom(value: configuration.range.wrappedValue.lowerBound,
                                          availableDistance: geometry.size.width - self
                                              .upperThumbSize.width,
                ...
                .gesture(DragGesture()
                    .onChanged { gestureValue in
                        ...
                        let computedLowerBound = valueFrom(distance: gestureValue.location
                            .x - (configuration.dragOffset.wrappedValue ?? 0),
                ...
                .position(x: distanceFrom(value: configuration.range.wrappedValue.upperBound,
                                          availableDistance: geometry.size.width,
                                          bounds: configuration.bounds,
                                          leadingOffset: self.lowerThumbSize.width + self
                                              .upperThumbSize.width / 2,
                ...
                .gesture(DragGesture()
                    .onChanged { gestureValue in
                        ...
                        let computedUpperBound = valueFrom(distance: gestureValue.location
                            .x - (configuration.dragOffset.wrappedValue ?? 0),
                            availableDistance: geometry.size.width,
                            bounds: configuration.bounds,
                            step: configuration.step,
                            leadingOffset: self.lowerThumbSize.width + self.upperThumbSize
                                .width / 2,
                            trailingOffset: self.upperThumbSize.width / 2)
        ...
        .frame(minHeight: max(lowerThumbInteractiveSize.height, upperThumbInteractiveSize.height))
    }
...
public extension HorizontalRangeSliderStyle where Track == DefaultHorizontalRangeTrack {
    init(lowerThumb: LowerThumb, upperThumb: UpperThumb,
         ...
         onSelectUpper: @escaping () -> Void = {})
    {
        track = DefaultHorizontalRangeTrack()
        self.lowerThumb = lowerThumb
        self.upperThumb = upperThumb
        self.lowerThumbSize = lowerThumbSize
        self.upperThumbSize = upperThumbSize
...
public extension HorizontalRangeSliderStyle where LowerThumb == DefaultThumb,
...
public extension HorizontalRangeSliderStyle where LowerThumb == DefaultThumb,
    UpperThumb == DefaultThumb, Track == DefaultHorizontalRangeTrack
{
